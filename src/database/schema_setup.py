    ...
    try:
        ...
        sql_script = """
            INSERT OR IGNORE INTO usuarios (id_usuario, nombre_completo, rol, email, password, estado)
                VALUES 
                    (1, 'Administrador del Sistema', 'Administrador', 'admin@vet.com', 'admin123', 1),
                    (2, 'Recepcionista', 'Recepcionista', 'recep@vet.com', 'recep123', 1),
                    (3, 'Farmacéutico', 'Farmacéutico', 'farma@vet.com', 'farma123', 1),
                    (4, 'Veterinario Principal', 'Veterinario', 'vet@vet.com', 'vet123', 1);
            """
